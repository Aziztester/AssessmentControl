...
#    And Type First name " " into First name field with x-path "//input[@placeholder='First Name']"
  ...
  Scenario Outline: User First Name Outline
    ...
    And Type Confirm password "12345" into Confirm Password field with x-path "//input[@placeholder='Confirm Password']"
    And Push "Register Me" button with x-path "//*[contains(text(),'Register Me')]"
    Then Verify the message "<message>" with path "<xpath>" is displayed
    Examples:
      | First   |Last     | message                        | xpath                                              |
      |iV@#7    | Ivanova | You have been Registered.      | //h4[contains(text(),'You have been Registered.')] |
      |  I      | Ivanova | You have been Registered.      | //h4[contains(text(),'You have been Registered.')] |
      |         | Ivanova | This field is required         | //*[@class='mat-error ng-star-inserted']           |
      |Ivanivan912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912345678912  | I | You have been Registered.                | //h4[contains(text(),'You have been Registered.')] |
      |Ivanivan9123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123456789123 | I | Data too long for column 'name' at row 1 | //div[@class='cdk-overlay-container']              |
      | ' Ivan' | rrr     | Whitespaces are not allowed    | //*[@class='mat-error ng-star-inserted']           |
      | 'Ivan ' | rrr     | Whitespaces are not allowed    | //*[@class='mat-error ng-star-inserted']           |
      | Iv an   | rrr     | Whitespaces are not allowed    | //*[@class='mat-error ng-star-inserted']           |
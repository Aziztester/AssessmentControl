...
#  Scenario: Student can see new assignments
  ...
  Scenario: Teacher deletes created Assignments
    ...
    Then element with xpath "//h4[contains(text(),'List of Assignments')]" should be displayed
    #Delete Assignment 3
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 3')]" with offset 5
    Then I click on element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 3')]/..//mat-icon[@class='mat-icon material-icons'][contains(text(),'more_vert')]"
    Then element with xpath "//span[contains(text(),'Delete Assignment')]" should be displayed
    Then I click on element with xpath "//span[contains(text(),'Delete Assignment')]"
    ...
    And I wait for 5 sec
    #Delete Assignment 2
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 2')]" with offset 5
    Then I click on element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 2')]/..//mat-icon[@class='mat-icon material-icons'][contains(text(),'more_vert')]"
    Then element with xpath "//span[contains(text(),'Delete Assignment')]" should be displayed
    Then I click on element with xpath "//span[contains(text(),'Delete Assignment')]"
    Then element with xpath "//h1[contains(text(),'Confirmation')]" should be displayed
    And I click on element with xpath "//span[contains(text(),'Delete')]"
    And I wait for 5 sec
    #Delete Assignment 1
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 1')]" with offset 5
    Then I click on element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 1')]/..//mat-icon[@class='mat-icon material-icons'][contains(text(),'more_vert')]"
    Then element with xpath "//span[contains(text(),'Delete Assignment')]" should be displayed
    Then I click on element with xpath "//span[contains(text(),'Delete Assignment')]"
    Then element with xpath "//h1[contains(text(),'Confirmation')]" should be displayed
    And I click on element with xpath "//span[contains(text(),'Delete')]"
  ...
  Scenario: Teacher deletes created Quizzes
    ...
    #Delete Quiz 1
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 1')]" with offset 5
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 1')]/../../.."
    Then element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 1')]/../../..//*[contains(text(), 'Delete')]" should be displayed
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 1')]/../../..//*[contains(text(), 'Delete')]"
    Then element with xpath "//h1[contains(text(),'Confirmation')]" should be displayed
    And I click on element with xpath "//div[@class='mat-dialog-actions']//span[contains(text(),'Delete')]"
    And I wait for 5 sec
    #Delete Quiz 2
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 2')]" with offset 5
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 2')]/../../.."
    Then element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 2')]/../../..//*[contains(text(), 'Delete')]" should be displayed
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 2')]/../../..//*[contains(text(), 'Delete')]"
    Then element with xpath "//h1[contains(text(),'Confirmation')]" should be displayed
    And I click on element with xpath "//div[@class='mat-dialog-actions']//span[contains(text(),'Delete')]"
    And I wait for 5 sec
    #Delete Quiz 3
    Then I scroll to the element with xpath "//*[contains(text(),'ASK-777 ASK-362 Quiz 3')]" with offset 5
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 3')]/../../.."
    Then element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 3')]/../../..//*[contains(text(), 'Delete')]" should be displayed
    Then I click on element with xpath "//*[contains(text(), 'ASK-777 ASK-362 Quiz 3')]/../../..//*[contains(text(), 'Delete')]"
    Then element with xpath "//h1[contains(text(),'Confirmation')]" should be displayed
    And I click on element with xpath "//div[@class='mat-dialog-actions']//span[contains(text(),'Delete')]"
    And I wait for 5 sec

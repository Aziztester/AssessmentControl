Feature: Assignment - Create (ASK-966)
  ...
  Scenario: Assignment - Create (ASK-967)
    ...
    And V assign quiz "123abc (Default, unchanged name)" to student "Sophia Jones"
    And V wait for "//*[contains(text(),'List of Assignments')]"
    Then V verify if quiz "123abc (Default, unchanged name)" assigned to student "Sophia Jones" in the List of Assignments
  ...
  Scenario: Assignment-Missing Group (ASK-1042)
    ...
    Then V verify "//div[@id='cdk-overlay-0']//*[contains(text(),'4222X')]" is not displayed
